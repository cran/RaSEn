...
We provide a detailed demo of the usage for the \verb+RaSEn+ package. This package implements the random subspace ensemble classification (RaSE) method (@tian2021rase) and the variable screening approach via RaSE (@tian2021variable).
